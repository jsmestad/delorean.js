(function() {
  ...
  (function($, window, document, undefined_) {
    ...
    Delorean = function(options) {
      var calculateLabelWidth, displayValue, distillData, log, mean, median, mode, parseDate, range, tintColor, tooltip;
      options = {
      ...
      Raphael.fn.drawChart = function(X, Y) {
        var c, dates, dates_length, first_point, i, j, k, kk, layer, leave_timer, line_paths, margin_bottom, margin_left, margin_top, point, point_array, point_size, point_size_hover, stroke_color, stroke_width, tooltip_visible, value, values, values_array, x, y, _results;
        line_paths = [];
        dates = _(data).keys();
    ...
    return $.delorean = function(target, data, options) {
      var delorean;
