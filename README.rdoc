...
Delorean.js is a charting library for time-based graphs built on top of Raphael.js

Screenshot: https://img.skitch.com/20110112-rh91n6uefyh1w4mesrqb2mqcuy.jpg
...
== Features
  ...
  * Support for multiple plot lines (WIP)
  * Tooltips (WIP)
...
The data format that Delorean.js accepts looks like:
